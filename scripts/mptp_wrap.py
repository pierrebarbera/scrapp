...
def run_mptp_processes( edge_dir, args ):
...
if __name__ == "__main__" and is_master():
    ...
    try:
        ...
        if comm_size > 1:
            ...
            for edge_dir in args.edge_dirs:
                futures.append( executor.submit( run_mptp_processes, edge_dir, args ) )
    ...
    if do_threading:
        results = [pool.apply_async( run_mptp_processes, args=(edge_dir, args)) for edge_dir in args.edge_dirs]
